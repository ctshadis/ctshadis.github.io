...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function getNewWord() {
    ...
    fetch(
      `https://wordsapiv1.p.rapidapi.com/words/?random=true&lettersMin=6&lettersMax=6&frequencyMin=5&frequencyMax=7&letterPattern=^[A-Za-z]{6}$`,
      {
        method: "GET",
        headers: {
  ...
  function handleSubmitWord() {
    ...
    fetch(`https://wordsapiv1.p.rapidapi.com/words/${currentWord}`, {
      ...
      .then((res) => {
        ...
        if (guessedWords.length === 7 && currentWord !== word) {
          doGamesCookie();
